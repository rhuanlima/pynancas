...
def import_db_gsheets(db_path):
    ...
    df_contas = (
        df_money[~df_money.duplicated(subset=["id_conta"])][["id_conta", "ds_conta"]]
    ...
    df_money = pd.merge(df_money, df_categorias[["id", "key"]], how="left", on="key")
